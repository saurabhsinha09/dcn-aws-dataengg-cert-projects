...
with DAG('data_validation_and_kpi_computation', default_args=default_args, schedule='@daily', catchup=False) as dag:
    ...
    calculate_hourly_kpis_task = PythonOperator(
    ...
    validate_datasets_task >> check_validation >> [calculate_genre_kpis_task, end_dag]
    calculate_genre_kpis_task >> calculate_hourly_kpis_task >> move_files