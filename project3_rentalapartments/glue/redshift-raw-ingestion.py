...
# Define constants
bucket_name = "s3://dcn-dataengg"
##redshift_iam_arn = "arn:aws:iam::<aws-account-id>:role/service-role/AmazonRedshift-CommandsAccessRole-20240716T164456"
...
redshift_iam_arn = credentials['redshift_iam_arn']
